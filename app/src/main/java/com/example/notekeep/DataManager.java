...
import com.example.notekeep.NoteKeeperDatabaseContract.CourseInfoEntry;
...
public class DataManager {
    ...
    public static void loadFromDatabase(NoteKeeperOpenHelper mdHelper){
        SQLiteDatabase db = mdHelper.getReadableDatabase();
        final String[] courseColumns = {CourseInfoEntry.COLUMN_COURSE_ID,
                CourseInfoEntry.COLUMN_COURSE_TITLE};

        String orderCourseBy = CourseInfoEntry.COLUMN_COURSE_TITLE;

        final Cursor courseCursor = db.query(CourseInfoEntry.TABLE_NAME, courseColumns, null,
                null, null, null, orderCourseBy);//query method returns a result type of cursor in no order
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        /*
        WE RECEIVE THE POSITION OF THE RESULTS IN THE CURSOR
        FROM THE QUERY BY GETTING THE INDEX
         */
        ...
        while(cursor.moveToNext()){
            /*
            HERE WE GET THE STRING VALUES  IN THE CURSOR COLUMN POSITIONS
             */
